...
That is the trade in one line. Run 2 was stable and gained a fifth as much. The amplification was not a bug that happened to be survivable, it was where most of the learning signal came from.
...
| Two reward scales | run 2 deltas incomparable to run 1's | the stored reward is the environment's; reports recompute through the pinned curve. Same guess: 0.0107 against 0.135 |
...
| Mismatched `k` | run 1 tying Sonnet 5 | baselines at pass@1 read Sonnet 0.6798; at pass@4, 0.6952 |
