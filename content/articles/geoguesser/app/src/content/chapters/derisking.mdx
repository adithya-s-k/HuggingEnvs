...
Skipping those six lines cost me a run.
...
This is the check I would push hardest on. Take two to four tasks, run many epochs on just those, and watch the reward.
