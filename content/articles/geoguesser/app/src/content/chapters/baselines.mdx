...
<Note>
This first sweep is scored on the environment's own reward curve, `exp(-distance_km / 1492.7)` minus a per-action cost, which is a **different scale** from the pass@4 numbers everywhere else in this article. The Reward section explains why the two exist and what mixing them cost us.
</Note>
