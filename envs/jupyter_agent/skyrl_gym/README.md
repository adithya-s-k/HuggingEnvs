...
If you want OpenAI tool-calling against the same backend, the **Verifiers** sibling folder exposes the same 4 tools as plain Python functions — see `envs/jupyter_agent/verifiers/`.
