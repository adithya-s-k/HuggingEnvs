...
Cross-platform (Windows / macOS / Linux) — this is the real launcher; the .sh / .ps1 are thin wrappers.
Uses the huggingface_hub SDK `run_job` (command passed as a list, so nothing gets shell-mangled).
